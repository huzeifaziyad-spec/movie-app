              ...
              >
                ...
                >
                  <Link
                    ...
                    className="bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 py-3 rounded-full font-bold hover:bg-white hover:text-black transition-all flex items-center gap-2 shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]"
                  >
                    Watch Now
                  </Link>
                  <button className="w-12 h-12 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-colors backdrop-blur-md">
                ...
                {isActive && (
                  <>
                    ...
                    {isExpanded && (
                      ...
                      >
                        <p className="text-white text-xs md:text-sm font-bold line-clamp-2">{movie.title}</p>
                      </motion.div>
                    )}
                    {/* Progress Bar */}
