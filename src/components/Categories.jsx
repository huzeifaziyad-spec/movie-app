...
const Categories = ({ selectedGenre, onGenreChange }) => {
  return (
    <div className="categories-container">
      ...
      <div className="categories-header">
        <div className="flex items-center gap-3">
          ...
          <div className="w-1.5 h-1.5 rounded-full bg-red-600 mt-5 ml-[-10px]"></div>
        </div>

        <div className="hidden md:flex items-center gap-10 text-gray-400 font-medium text-sm">
